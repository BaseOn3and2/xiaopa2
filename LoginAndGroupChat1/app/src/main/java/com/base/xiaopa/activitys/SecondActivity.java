...
//                    resetColor();
//                    introduce.setTextColor(orange);
                }else if(vp_pager.getCurrentItem()==1) {
//                    resetColor();
//                    comment.setTextColor(orange);
                }else if(vp_pager.getCurrentItem()==2) {
//                    resetColor();
//                    imgShow.setTextColor(orange);
                }
            }
        };
    ...
    {
        introduce.setTextColor(0x7f0d0022);
        comment.setTextColor(0x7f0d0022);
        imgShow.setTextColor(0x7f0d0022);
    }
}
